---
docId: GOV-GUIDE-414
title: Studio Strategic Context
version: 1.0.0
...
```mermaid
graph TD
    A["<b>Studio Mission</b><br><i>Our reason for being</i>"] --> B["<b>Flagship Project Vision</b><br><i>What we are building</i>"];
    B --> C["<b>Organizational Structure</b><br><i>A team of specialized Gems</i>"];
    B --> D["<b>Collaboration Philosophy</b><br><i>How we work together</i>"];
    C & D --> E("<b>Project Success</b>");

    style A fill:#cce5ff,stroke:#004085
    style B fill:#d4edda,stroke:#155724
    style E fill:#fcf8e3,stroke:#8a6d3b
```
