---
docId: GOV-GUIDE-012
title: 'Gencraft Agent Charter: Identity, Roles, and Ethics'
version: 2.0.0
...
metadata:
  ...
  - roles
  - ai-agent
ssot_path: https://github.com/GenCr-ft/gcs-core-governance/blob/main/reference-libraries/studio-handbook/ai-operational-guides/grounding-docs/GOV-GUIDE-012.gencraft-agent-charter-identity-roles-and-ethics.md
---
...
```mermaid
graph TD
    A["<b>1. Agent Charter (You)</b><br><i>Your Core Identity & Rules</i>"] --> B["<b>2. Operational Playbook (Act)</b>"];
    A --> C["<b>3. Unified Technical Standard (Build)</b>"];
    A --> D["<b>4. SSoT Contributor Guide (Document)</b>"];
    A --> E["<b>5. Studio Reference (Know)</b>"];

    style A fill:#cce5ff,stroke:#004085,stroke-width:3px
```
